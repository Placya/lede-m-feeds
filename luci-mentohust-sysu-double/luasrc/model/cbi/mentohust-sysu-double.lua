...
m = Map("mentohust-sysu-double", translate("MentoHUST"), translate("锐捷、赛尔认证客户端."))
function m.on_commit(self)
os.execute("/etc/init.d/mentohust-sysu-double start")
end
...
s = m:section(TypedSection, "mentohust-sysu-double", translate("设置mentohust"),translate("以下选项为mentohust的参数"))
s.anonymous = true
...
s:option(Value, "DataFile", translate("自定义数据文件"),translate("默认不使用")).default="/etc/mentohust-sysu-double"
